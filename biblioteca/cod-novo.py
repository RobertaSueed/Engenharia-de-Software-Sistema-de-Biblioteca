...
class BibliotecaGUI:
    def __init__(self, root):
        ...
        self.root.geometry("612x288")  # Tamanho da janela
        self.root.configure(bg="white")

        img = PhotoImage(file="biblioteca_foto.png")
        ...
        # Adicionar texto em cima da imagem
        self.label_texto = tk.Label(root, text="Escolha uma opção:", font=("Arial", 16, "bold"), bg="white")
        self.label_texto.place(relx=0.5, rely=0.1, anchor="center")
        

        self.criar_button = tk.Button(root, text="Criar Cadastro", command=self.criar_cadastro, font=("Arial", 10, "bold"), bg="green")
        self.criar_button.place(relx=0.5, rely=0.2, anchor="center")


        self.criar_button = tk.Button(root, text="Alterar Cadastro", command=self.alterar_cadastro, font=("Arial", 10, "bold"), bg="green")
        #self.alterar_button.pack()
        self.criar_button.place(relx=0.5, rely=0.3, anchor="center")


        self.criar_button = tk.Button(root, text="Pesquisar Cadastro", command=self.pesquisar_cadastro, font=("Arial", 10, "bold"), bg="green")
        #self.pesquisar_button.pack()
        self.criar_button.place(relx=0.5, rely=0.4, anchor="center")


        self.criar_button = tk.Button(root, text="Exibir Livros", command=self.exibir_livros, font=("Arial", 10, "bold"), bg="green")
        #self.exibir_button.pack()
        self.criar_button.place(relx=0.5, rely=0.5, anchor="center")


        self.criar_button = tk.Button(root, text="Alugar Livro", command=self.alugar_livro, font=("Arial", 10, "bold"), bg="green")
        #self.alugar_button.pack()
        self.criar_button.place(relx=0.5, rely=0.6, anchor="center")


        self.criar_button = tk.Button(root, text="Devolver Livro", command=self.devolver_livro, font=("Arial", 10, "bold"), bg="green")
        #self.devolver_button.pack()
        self.criar_button.place(relx=0.5, rely=0.7, anchor="center")


        self.criar_button = tk.Button(root, text="Remover Cadastro", command=self.remover_cadastro, font=("Arial", 10, "bold"), bg="green")
        #self.remover_button.pack()
        self.criar_button.place(relx=0.5, rely=0.8, anchor="center")
        

        self.criar_button = tk.Button(root, text="Sair", command=root.destroy, font=("Arial", 10, "bold"), bg="red")
        #self.sair_button.pack()
        self.criar_button.place(relx=0.5, rely=0.9, anchor="center", )
...
#--------------------------------------------------------------------------------------------------------
    ...
    def criar_cadastro(self):
        ...
        self.confirmar_button = tk.Button(cadastro, text="Confirmar", command=confirmar_envio, bg="blue", fg="white")
...
#--------------------------------------------------------------------------------------------------------
    ...
    def alterar_cadastro(self):
        ...
        # Botão de pesquisa
        self.pesquisar_button = tk.Button(cadastro, text="Pesquisar", command=realizar_pesquisa, bg="blue", fg="white")
        self.pesquisar_button.pack()
    ...
    def abrir_janela_edicao(self, nome, nascimento, telefone, email):
        ...
        # Botão de confirmação
        self.confirmar_button = tk.Button(janela_edicao, text="Confirmar", command=self.confirmar_edicao, bg="blue", fg="white")
        self.confirmar_button.pack()
...
#--------------------------------------------------------------------------------------------------------
    ...
    def pesquisar_cadastro(self):
        ...
        self.pesquisar_cadastro_button = tk.Button(cadastro, text="Pesquisar Cadastro", command=realizar_pesquisa, bg="blue", fg="white")
    ...
    def alugar_livro(self):
        ...
        self.verificar_cpf_button = tk.Button(aluguel_janela, text="Verificar CPF", command=verificar_cpf, bg="blue", fg="white")
    ...
    def devolver_livro(self): 
        ...
        # Botão para verificar o CPF
        verificar_button = tk.Button(janela_devolver, text="Verificar CPF", bg="blue", fg="white", command=lambda: self.verificar_cpf_devolucao(janela_devolver, cpf_entry.get()))
    ...
    def remover_cadastro(self):
        ...
        self.confirmar_button = tk.Button(remover, text="Confirmar", command=confirmar_remover_cadastro, bg="blue", fg="white")
        self.confirmar_button.pack()
