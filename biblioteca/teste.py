...
class BibliotecaGUI:
    def __init__(self, root):
        ...
        self.menu_label = tk.Label(root, text="Escolha uma opção:", font=("Arial", 15, "bold"))
        self.menu_label.pack(pady=5)

        self.criar_button = tk.Button(root, text="Criar Cadastro", command=self.criar_cadastro, bg="green", fg="white", borderwidth=2, relief="raised", width=15, height=2, font=("Arial", 12, "bold"))
        self.criar_button.pack(pady=5)

        self.alterar_button = tk.Button(root, text="Alterar Cadastro", command=self.alterar_cadastro, bg="green", fg="white", borderwidth=2, relief="raised", width=15, height=2, font=("Arial", 12, "bold"))
        self.alterar_button.pack(pady=5)

        self.pesquisar_button = tk.Button(root, text="Pesquisar Cadastro", command=self.pesquisar_cadastro, bg="green", fg="white", borderwidth=2, relief="raised", width=15, height=2, font=("Arial", 12, "bold"))
        self.pesquisar_button.pack(pady=5)

        self.exibir_button = tk.Button(root, text="Exibir Livros", command=self.exibir_livros, bg="green", fg="white", borderwidth=2, relief="raised", width=15, height=2, font=("Arial", 12, "bold"))
        self.exibir_button.pack(pady=5)

        self.alugar_button = tk.Button(root, text="Alugar Livro", command=self.alugar_livro, bg="green", fg="white", borderwidth=2, relief="raised", width=15, height=2, font=("Arial", 12, "bold"))
        self.alugar_button.pack(pady=5)

        self.devolver_button = tk.Button(root, text="Devolver Livro", command=self.devolver_livro, bg="green", fg="white", borderwidth=2, relief="raised", width=15, height=2, font=("Arial", 12, "bold"))
        self.devolver_button.pack(pady=5)

        self.remover_button = tk.Button(root, text="Remover Cadastro", command=self.remover_cadastro, bg="green", fg="white", borderwidth=2, relief="raised", width=15, height=2, font=("Arial", 12, "bold"))
        self.remover_button.pack(pady=5)

        self.sair_button = tk.Button(root, text="Sair", command=root.destroy, bg="red", fg="white", borderwidth=2, relief="raised", width=13, height=1, font=("Arial", 12, "bold"))
...
#--------------------------------------------------------------------------------------------------------
    ...
    def pesquisar_cadastro(self):
        ...
        self.pesquisar_cadastro_button.pack(pady=5)
